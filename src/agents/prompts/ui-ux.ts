...
2. Design System — a concrete color palette with hex codes, typography (families, sizes, weights), component styles for buttons/inputs/cards/modals, and spacing & layout rules.
